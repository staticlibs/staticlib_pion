...
#ifndef STATICLIB_HTTPSERVER_TRIBOOL_HPP
#define STATICLIB_HTTPSERVER_TRIBOOL_HPP

#if defined(_MSC_VER)
#  pragma once
#endif

namespace staticlib { namespace httpserver { namespace logic {
...
inline bool                                                             \
Name(staticlib::httpserver::logic::tribool x,                                           \
     staticlib::httpserver::logic::detail::indeterminate_t =                            \
       staticlib::httpserver::logic::detail::indeterminate_t())                         \
{ return x.value == staticlib::httpserver::logic::tribool::indeterminate_value; }

#endif // STATICLIB_HTTPSERVER_TRIBOOL_HPP
