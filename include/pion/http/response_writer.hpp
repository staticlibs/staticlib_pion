 ...
 */
class PION_API response_writer : public std::enable_shared_from_this<response_writer>, private pion::noncopyable {
...
private:
     ...
     */
    void prepare_buffers_for_send(http::message::write_buffers_t& write_buffers);
     ...
     */
    write_handler_t bind_to_write_handler();
 ...
 */
typedef std::shared_ptr<response_writer> writer_ptr;
