 ...
 */
class PION_API message : public http::types {
public:
    ...
    struct receive_error_t : public asio::error_category {
         ...
         * Destructor
         */
        virtual ~receive_error_t() PION_NOEXCEPT;
         ...
         */
        virtual const char* name() const PION_NOEXCEPT;
...
public:
     ...
     */
    void prepare_buffers_for_send(write_buffers_t& write_buffers, const bool keep_alive,
     ...
     */
    std::size_t send(tcp::connection& tcp_conn, asio::error_code& ec, bool headers_only = false);
     ...
     */
    std::size_t receive(tcp::connection& tcp_conn, asio::error_code& ec, parser& http_parser);
     ...
     * @return std::size_t number of bytes read from the connection
     */
    std::size_t receive(tcp::connection& tcp_conn, asio::error_code& ec, bool headers_only = false,
     ...
     * @return std::size_t number of bytes read from the connection
     */
    std::size_t read(std::istream& in, asio::error_code& ec, parser& http_parser);
